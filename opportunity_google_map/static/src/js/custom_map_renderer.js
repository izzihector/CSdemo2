odoo.define('web_map.MapRenderer', function (require) {
    ...
    class MapRenderer extends AbstractRendererOwl {
        ...
        async willStart() {
            const p = { method: 'GET' };
            [this._pinCircleSVG, this._pinNoCircleSVG, this._pingreenSVG, this._pinyellowSVG, this._pinblueSVG, this._pinlightgreenSVG,
            this._pinredSVG, this._pinmagentaSVG, this._pinblackSVG, this._pinpurpleSVG, this._pinorangeSVG, this._pinpinkSVG,
            this._pingreySVG, this._pinbrownSVG, this._pincyanSVG, this._pinwhiteSVG] = await Promise.all([
                ...
                this.env.services.httpRequest('opportunity_google_map/static/src/img/green.svg', p, 'text'),
                this.env.services.httpRequest('opportunity_google_map/static/src/img/yellow.svg', p, 'text'),
                this.env.services.httpRequest('opportunity_google_map/static/src/img/blue.svg', p, 'text'),
                this.env.services.httpRequest('opportunity_google_map/static/src/img/lightgreen.svg', p, 'text'),
                this.env.services.httpRequest('opportunity_google_map/static/src/img/red.svg', p, 'text'),
                this.env.services.httpRequest('opportunity_google_map/static/src/img/magenta.svg', p, 'text'),
                this.env.services.httpRequest('opportunity_google_map/static/src/img/black.svg', p, 'text'),
                this.env.services.httpRequest('opportunity_google_map/static/src/img/purple.svg', p, 'text'),
                this.env.services.httpRequest('opportunity_google_map/static/src/img/orange.svg', p, 'text'),
                this.env.services.httpRequest('opportunity_google_map/static/src/img/pink.svg', p, 'text'),
                this.env.services.httpRequest('opportunity_google_map/static/src/img/grey.svg', p, 'text'),
                this.env.services.httpRequest('opportunity_google_map/static/src/img/brown.svg', p, 'text'),
                this.env.services.httpRequest('opportunity_google_map/static/src/img/cyan.svg', p, 'text'),
                this.env.services.httpRequest('opportunity_google_map/static/src/img/white.svg', p, 'text')
            ]);
        ...
        _addMarkers() {
            ...
            for (const markerInfo of Object.values(markersInfo)) {
                var icon_color = markerInfo.record.xaa_aa_lead_marker_color;
                const params = {
                ...
                if (icon_color && MARKER_ICON_COLORS.indexOf(icon_color) !== -1) {
                    var pinColor = 'this._pin' + icon_color + 'SVG';
                    params.pinSVG = eval(pinColor);
                }
